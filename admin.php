...
<a href="login.php?action=register" class="btn btn-success">User Acc</a>
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate"  value="<?php echo date('Y-m-d'); ?>" readonly>
						</div>
						<div class="form-group col-md-2">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate"  name="saleReportStartDate"  value="<?php echo date('Y-m-d'); ?>" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate"  name="saleReportEndDate"  value="<?php echo date('Y-m-d'); ?>" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate"  name="purchaseReportStartDate"  value="<?php echo date('Y-m-d'); ?>" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate"  name="purchaseReportEndDate"  value="<?php echo date('Y-m-d'); ?>" readonly>>
								  </div>
							  </div>
