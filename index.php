...
<style>
        body {
            background: url('yellowbgc.JPG') no-repeat center center fixed;
...
?>
<link rel="stylesheet" type="text/css" href="assets/css/shop-styles.css">
    <!-- Page Content -->
	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			...
			<!--   <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Item</a>-->
			 <!--  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false">Stock</a>-->
				  ...
				  <div class="card-body">
					...
					<div class="tab-content">
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<p>1	You can upload an image for a particular item using this section.</p> 
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2024-07-24">
						</div>
						<div class="form-group col-md-2">
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
							...
							<input type="text" class="form-control" id="saleDetailsCustomerID" name="saleDetailsCustomerID" value="1" autocomplete="off">
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate"  name="saleDetailsSaleDate" value="<?php echo date('Y-m-d'); ?>" readonly>
						  </div>
					  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate" value="2024-07-24" name="saleReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate" value="2024-07-24" name="saleReportEndDate" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate" value="2024-07-24" name="purchaseReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate" value="2024-07-24" name="purchaseReportEndDate" readonly>
								  </div>
							  </div>
